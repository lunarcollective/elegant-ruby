...
class Elegant::Request::QueryTest < Minitest::Test
  def subject
    @subject ||= Elegant::Request::Query.new()
  end
  ...
  def test_content_type_looks_up_content_type
    expected = "filter[type]=players&filter[status]=live&filter[publish_status]=published&page[number]=1&page[size]=25&sort=updated_at"
